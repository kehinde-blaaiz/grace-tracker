  ...
  return (
    <div style={{ marginTop: '4px' }}>
      ...
      >
        {state === 'idle' && (
          <>
            <i className="ti ti-hand-finger" style={{ fontSize: '16px' }} aria-hidden="true" />
            Nudge {toName}
          </>
        )}
        {state === 'sending' && (
          <>
            <i className="ti ti-loader" style={{ fontSize: '16px' }} aria-hidden="true" />
            Sending...
          </>
        )}
        {state === 'sent' && (
          <>
            ...
            Nudge sent — {toName} will be notified
          </>
        )}
        {state === 'error' && (
          <>
