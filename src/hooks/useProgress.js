...
export function useProgress(userId) {
  const [data, setData] = useState({
    readings: {}, verses: {}, weeklyVerses: {}, ssProgress: {},
    prayers: {}, offerings: {},
  ...
  const fetchAll = useCallback(async () => {
    ...
    setData({
      readings: readingsMap, verses: versesMap, weeklyVerses: weeklyMap,
      ssProgress: ssMap, prayers: prayersMap, offerings: offeringsMap,
