      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '28px' }}>
          <div style={{
            ...
            <img
              src="/grace-logo.png"
              alt="Grace and Growth"
              style={{ width: '100%', height: '100%', objectFit: 'cover' }}
            />
          </div>
          <div style={{ fontSize: '22px', fontWeight: '600', color: '#1a1a12', marginBottom: '4px' }}>
            Grace & Growth
          </div>
          ...
          {mode === 'signup' && (
            <input
              ...
              style={{
                ...
                border: '0.5px solid #e8e6e2', borderRadius: '12px',
        ...
        {error && (
          <div style={{
            ...
            fontSize: '13px', color: '#791F1F', marginBottom: '12px',
          }}>
            {error}
          </div>
        )}
        ...
        {success && (
          <div style={{
            ...
            borderRadius: '10px', padding: '10px 12px',
            fontSize: '13px', color: '#27500A', marginBottom: '12px',
          }}>
            {success}
          </div>
        )}
        ...
        <button
          ...
          style={{
            ...
            background: loading ? '#639922' : '#1a3a0a',
